        ...
        return(
            ...
            <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
              <div className="text-sm lg:flex-grow">
                <Link to={"/surveys"} className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                  Dashboard
                </Link>
                <Link to={"/surveys"} className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                  Surveys
                </Link>
                <Link to={"/surveys/new"} className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
                  New Survey
                </Link>
              </div>
